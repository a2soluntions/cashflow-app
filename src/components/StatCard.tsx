...
const StatCard: React.FC<StatCardProps> = ({ title, value, icon: Icon, color, compact, trend }) => {
 return (
 <div className={`bg-white dark:bg-slate-900/40 rounded-[2rem] flex flex-col relative overflow-hidden transition-transform hover:scale-[1.02] ${compact ? 'p-5' : 'p-6'}`}>
 <div className="flex justify-between items-start mb-2">
 <div className={`p-3 rounded-2xl ${color} -indigo-500/10`}>
