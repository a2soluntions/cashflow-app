...
export default function BudgetAlerts() {
  ...
  if (alerts.length === 0) {
    return (
      <div className="p-6 rounded-[2rem] bg-emerald-50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/20 flex flex-col items-center justify-center text-center">
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid gap-3">
        {alerts.map((alert) => (
          <div 
            key={alert.id}
            className={`p-4 rounded-[1.8rem] border-2 transition-all shadow-sm ${
              alert.isOver 
              ? 'bg-white dark:bg-rose-500/5 border-rose-500/20 shadow-rose-500/5' 
              : 'bg-white dark:bg-amber-500/5 border-amber-500/20 shadow-amber-500/5'
            }`}
          >
            ...
            <div className="flex justify-between items-center bg-slate-50 dark:bg-black/20 p-2.5 rounded-xl">
