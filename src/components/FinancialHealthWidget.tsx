  ...
  return (
    <div className="h-full overflow-y-auto p-1 pb-20 lg:pb-1 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-zinc-800 relative overflow-hidden group">
             ...
             <div className="relative z-10">
                 ...
                 <div className="mt-6 p-4 rounded-2xl bg-slate-50 dark:bg-zinc-800/50 border border-slate-100 dark:border-zinc-800">
          ...
          <div className="bg-white dark:bg-zinc-900 p-6 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-zinc-800">
             ...
             <div className="space-y-4">
                {analysis.sortedCategories.length > 0 ? (
                    analysis.sortedCategories.map(([cat, amount], idx) => (
                        <div key={cat} className="flex items-center justify-between p-3 hover:bg-slate-50 dark:hover:bg-zinc-800/50 rounded-2xl transition-colors border-b border-slate-50 dark:border-zinc-800 last:border-0">
