...
const Toast: React.FC<ToastProps> = ({ message, type, onClose }) => {
 ...
 return (
 <div className={`fixed top-6 right-6 z-[200] flex items-center gap-4 px-6 py-5 rounded-3xl -2xl animate-in slide-in-from-right-full duration-300 backdrop-blur-xl ${
 type === 'success' 
