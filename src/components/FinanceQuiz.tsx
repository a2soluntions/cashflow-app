...
const questionsPool: Question[] = [
 ...
 { id: 2, question: "Qual a regra A2 Mentor para aumentos?", options: ["Gastar tudo", "Mudar de casa", "50% Investir / 50% Viver", "Comprar um carro"], correct: 2, explanation: "Isso trava a inflação do seu estilo de vida." },
 ...
 { id: 20, question: "A Riqueza no A2 Mentor é definida por:", options: ["Ter carros", "Liberdade e controle sobre o tempo", "Saldo alto no banco", "Gastar muito"], correct: 1, explanation: "Dinheiro é apenas a ferramenta para sua liberdade real." },
];
...
const phrases = [
 ...
 "O mercado treina pessoas para gastar. O A2 Mentor treina você para dominar!",
