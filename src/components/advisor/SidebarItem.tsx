...
export const SidebarItem = ({ label, icon, active, onClick }: any) => (
    <button 
        onClick={onClick}
        className={`w-auto md:w-full flex items-center justify-center md:justify-between px-4 md:px-6 py-4 md:py-5 md:rounded-2xl rounded-xl transition-all duration-500 group shrink-0 ${
            active 
            ? 'bg-indigo-600 text-white shadow-[0_10px_20px_rgba(79,70,229,0.3)] md:shadow-[0_20px_50px_rgba(79,70,229,0.3)] md:scale-[1.02]' 
