...
const LegalPage: React.FC = () => {
  ...
  const content = {
    privacy: {
      ...
      text: `
        Esta Política de Privacidade descreve como o VittaCash coleta, utiliza e protege suas informações pessoais.
    ...
    terms: {
      ...
      text: `
        Ao utilizar o VittaCash, você concorda com os seguintes termos e condições:
    ...
    cookies: {
      ...
      text: `
        ...
        4. Controle: Você pode desativar os cookies nas configurações do seu navegador, mas isso pode afetar o funcionamento de algumas partes do VittaCash.
      `
    },
    security: {
    ...
    <div className="min-h-screen bg-[#283593] text-white font-sans p-6 md:p-12 pt-24 md:pt-32 animate-in fade-in duration-700">
      <div className="max-w-3xl mx-auto bg-zinc-900/50 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col items-center text-center">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 mb-2">VittaCash Compliance</p>
