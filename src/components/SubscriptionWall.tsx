    ...
    <div className="fixed inset-0 z-[200] bg-black/90 backdrop-blur-xl flex items-center justify-center p-4 font-sans">
      ...
      {stage === 'success' && (
        <div className="flex flex-col items-center gap-6 animate-in zoom-in-90 duration-500 text-center">
          <div className="w-24 h-24 rounded-full bg-emerald-500/20 flex items-center justify-center shadow-[0_0_60px_rgba(16,185,129,0.4)]">
        ...
        <div className="w-full max-w-2xl animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            {PLANS.map(plan => (
              ...
              >
                {plan.badge && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-emerald-500 text-white text-[10px] font-black uppercase tracking-wider rounded-full shadow-lg">
                    {plan.badge}
                  </div>
                )}
          ...
          {errorMsg && (
            <div className="mb-4 p-3 bg-rose-500/10 border border-rose-500/30 rounded-xl flex items-center gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-5 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-black uppercase tracking-widest rounded-2xl shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all active:scale-[0.98] disabled:opacity-60 flex items-center justify-center gap-3 text-sm"
          >
      ...
      {stage === 'pix' && (
        <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
          <div className="bg-zinc-900 border border-white/10 rounded-[3rem] p-8 shadow-2xl">
            {/* Header */}
